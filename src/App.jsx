...
function App() {
  ...
  return <div className="flex flex-col">
    ...
    {era === 700 && (
      <Poi x={70} y={100} color="#ffffff" name={"Era Overview"} desc={"601-700 AD: start of the great northern age, saxons move to the british isles and become anglo-saxons, chaos still reigns in europe but many are unified by christianity"}/>
    )}
    ...
    {era === 1200 && (
      <Poi x={70} y={100} color="#ffffff" name={"Era Overview"} desc={"1101-1200 AD: england and france are fully laid out as the strongest feudal societies in western europe before the HRE. they have a heated rivalry and cause major discourse. spanish conquista begins after centuries of muslim dominance"}/>
    )}
    ...
    {era === 1400 && (
      <Poi x={70} y={100} color="#ffffff" name={"Era Overview"} desc={"1301-1400 AD: angevin empire falls apart. mongols reach europe, causing a dangerous threat that nearly wipes out the byzantine empire. novgorod sees some success in unifying russian tribes, italian city-states resist the HRE's iron grip"}/>
    )}

    {era === 1500 && (
      <Poi x={70} y={100} color="#ffffff" name={"Era Overview"} desc={"1401-1500 AD: middle ages end, gunpowder reaches europe and ship industry advances. byzantines will soon be defeated by the ottomans"}/>
    )}
    ...
    {era === 1700 && (
      <Poi x={70} y={100} color="#ffffff" name={"Era Overview"} desc={"1601-1700 AD: colonization goes huge, enlightenment wears off and leaves us with many different religions"}/>
    )}

    {era === 1800 && (
      <Poi x={70} y={100} color="#ffffff" name={"Era Overview"} desc={"1701-1800 AD: colonization in full swing, america will declare independence more than halfway through the century"}/>
    )}

    {era === 1900 && (
      <Poi x={70} y={100} color="#ffffff" name={"Era Overview"} desc={"1801-1900 AD: napoleonic wars overtake europe. later on, the industrial revolution occurs. scramble for africa leaves only two independent nations: ethiopia and liberia"}/>
    )}

    {era === 2000 && (
      <Poi x={70} y={100} color="#ffffff" name={"Era Overview"} desc={"1901-2000 AD: perhaps the most revolutionary era. ww1, ww2, and the cold war has taken place. after the carnage, the world is at relative peace, information era in full swing"}/>
    )}
